...
```{r install_devtools, warning=FALSE}
install.packages('devtools')
```

#####Github installation

```{r install_ksea_github, warning=FALSE}
require(devtools)
...
```{r install_ksea_locally, warning=FALSE}
require(devtools)
install("./ksea")
